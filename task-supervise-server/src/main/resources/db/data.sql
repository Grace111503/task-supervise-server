...
INSERT INTO sys_user (id, username, password, name, email, phone, avatar, dept_id, position, role) VALUES
...
-- 初始任务数据（按部门归属，用于权限过滤）
INSERT INTO task (id, title, description, status, priority, dept_id, deadline, remark, creator_id, creator_name, assignee_id, assignee_name) VALUES
